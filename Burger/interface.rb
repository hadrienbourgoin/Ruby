...
bigger_burger = burger("fish", "mayo", "salad") { |mypatty| mypatty.upcase }
p bigger_burger
...
juicy_burger = burger("steak", "barbecue", "cheddar") do |mypatty|
  mypatty.gsub!(/[aeiou]/i, "~")
end
p juicy_burger
...
spicy_burger = burger("chicken", "ketchup", "cheddar") do |mypatty|
  mypatty.insert(0, '*')
  mypatty.insert(mypatty.length, '*')
end
p spicy_burger
